...
exports.AccessControl = function(request,response){
    if(exports.authIsOwner(request,response) === false){
            response.writeHead(200,{'Content-Type': 'text/html'});
            response.end('Login required!! <br><a href="/login">login</a>');
        }
};
...
exports.login = function(request, response){
    db.query(`SELECT * FROM topic`, function(error,topics){
            ...
            var html = template.HTML(title,list,
                ...
                exports.SetAuthStatusUI(request, response));
